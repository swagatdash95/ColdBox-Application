  ...
  <div id="main">
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li class="selected"><a href="index.cfm?event=USERHOMEPAGE.getUserProfile">My Profile</a></li>
    ...
    <div style="background-color: black; color: white; height: 400px">
      <p style = "font-size: 20px">
        User Name: <cfoutput>#SESSION.validUserName#</cfoutput>
      </p>
      <p style = "font-size: 20px">
        User Email: <cfoutput>#SESSION.validUserEmail#</cfoutput>
      </p>
      <p style = "font-size: 20px">
        User Photo: <cfoutput><cfimage action="writeToBrowser"  source="#SESSION.uPhotoURL#" height = "100" width = "100" format = "JPG"/></cfoutput>
      </p>
    </div>
  </div>
